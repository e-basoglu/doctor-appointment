...
const appointmentDetailsSection = document.getElementById('appointment-details');
    ...
    if (data) {
        ...
        appointmentButtons.forEach(button => {
            button.addEventListener('click', (event) => {
                ...
                const otherDoctorItems = Array.from(doctorsBlock.children).filter(item => item !== clickedDoctor);
